...
struct UniversityHall: UIViewRepresentable {
    class Coordinator {
    ...
    func makeUIView(context: Context) -> MKMapView {
        ...
        let coordinate = CLLocationCoordinate2D(latitude: 44.046597, longitude: -123.076498)
...
struct UniversityHallDetailView: View {
    var body: some View {
        ScrollView {
            // Embedding the map
            UniversityHall()
